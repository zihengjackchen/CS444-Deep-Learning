...
class Agent():
    ...
    def train_policy_net(self, frame):
        ...
        max_next_state_q_values = next_state_q_values.max(1)[0].detach()
        expected_Q_values = (next_state_values * self.discount_factor * mask) + rewards

        # Compute the Huber Loss
        ### CODE ####
        loss = self.criterion(cur_q_values, expected_Q_values.unsqueeze(1))
